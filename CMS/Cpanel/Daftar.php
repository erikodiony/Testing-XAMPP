...
<html lang="en">
<head>
  <title>./Hello World - Daftar</title>
  <meta charset="utf-8">
...
<nav class="navbar navbar-default navbar-fixed-bottom">
	...
	<li role="presentation" class="active"><a href="Daftar.php"><span class="glyphicon glyphicon-user"></span> Daftar</a></li>
...
<br><br><br>
<div class="container">
	<div><h3>./Daftar</h3></div>
<div class="row">
<form class="form-horizontal" action="CekDaftar.php" method="post">
  ...
  <div class="form-group">
    <div class="col-md-offset-2 col-md-10">
      <button type="submit" class="btn btn-primary"><span class="glyphicon glyphicon-user"></span>&nbsp Daftar</button>
    </div>
  </div>
</form>
