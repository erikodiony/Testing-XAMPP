...
?>
	...
	<select id="combo_<?php echo $x;?>" name="obat[]" onchange="updateValue_<?php echo $x;?>()">
	...
	<option value="<?php echo $dataTampil['hrg_obat'] ; ?>"><?php echo $dataTampil['nama_obat'] ; ?></option>
		...
		<input type="text" id="kol_<?php echo $x;?>" />
		<input type="text" id="kol2_<?php echo $x;?>" />
		<input type="text" class="it" id="kol3_<?php echo $x;?>" />
