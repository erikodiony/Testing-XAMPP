...
<div class="row">
			...
			<center><h3><span class="glyphicon glyphicon-dashboard"></span>&nbsp Panel Menu</h3></center>
				<table class="table">
					<thead>
						...
						<tr><th><a href="RiwayatMasuk.php?per_page=5" style="text-decoration:none"><span class="glyphicon glyphicon-save"></span>  &nbsp Riwayat Surat Masuk</a></th></tr>
			            <tr><th><a href="RiwayatKeluar.php?per_page=5" style="text-decoration:none"><span class="glyphicon glyphicon-open"></span> &nbsp Riwayat Surat Keluar</a></th></tr>
	...
	<div class="col-md-9">
		...
		<div class="col-md-6">
			<h4 class="text-right"><b><a href="../Admin" style="text-decoration:none"><span class="glyphicon glyphicon-refresh"></span> Segarkan</a></b></h4>
		</div>
		<div class="col-md-12">
	...
	<div class="modal-dialog modal-xs">
		<div class="modal-content">
			...
			<div class="modal-body" >
								...
								<br>
								<form id="formPencarianTgl" class="form-horizontal" action="PencarianTgl.php" method="post">
									<div class="form-group">
								...
								<br>
								<form id="formPencarianNo" class="form-horizontal" action="PencarianNo.php" method="post">
									<div class="form-group">
										<label class="col-md-3 control-label">Kata Kunci</label>
											<div class="col-md-7 inputGroupContainer">
												<div class="input-group">
...
<div class="modal fade" id="ppTambahAkun" tabindex="-1" role="dialog" data-keyboard="false" data-backdrop="static" aria-hidden="true">
	<div class="modal-dialog modal-md">
		<div class="modal-content">
			...
			<div class="modal-body" >
				<form id="formTambahAkun" class="form-horizontal" action="CekTambahAkun.php" method="post" enctype="multipart/form-data">
						<div class="form-group">
							<label class="col-md-3 control-label">Nama Pengguna</label>
								<div class="col-md-6 inputGroupContainer">
									<div class="input-group">
								...
								<div class="panel-body">
									...
									?> 
										<tr>
											...
											<td><center><?php echo $dataTampil['level']; ?></center></td> 
											<td><div align="center">
												<a href="cekHapusAkun.php?user=<?php echo $dataTampil['user'] ; ?>"><span class="glyphicon glyphicon-trash"></span></a></div>
											</td>  
										</tr> 
									<?php } ?> 
									</table>
				...
				<div role="tabpanel">
					...
					<!-- Tab panes -->
						<div class="tab-content">
							...
							<div role="tabpanel" class="tab-pane fade in active" id="TabSuratMasuk">
								<form id="formTambahSuratMasuk" class="form-horizontal" action="cekBuatSuratMasuk.php" method="post">
									<div class="form-group">
					...
					?>
							...
							<div role="tabpanel" class="tab-pane fade in" id="TabSuratKeluar">
								<form id="formTambahSuratKeluar" class="form-horizontal" action="cekBuatSuratKeluar.php" method="post">
									<div class="form-group">
										<label class="col-md-2 control-label">*No. Entri</label>
											<div class="col-md-3 inputGroupContainer">
												<div class="input-group">
