	...
	<div class="modal-dialog modal-lg">
		<div class="modal-content">
			...
			<div class="modal-header">
				...
				<h3><img src="Images/logo.png" alt="Logo" width="80" height="80">&nbsp &nbsp Aplikasi Pengelolaan Surat Dinsosnaker Kota Kediri (Berbasis Web)</h3>
				</h4>
			</div>
			...
			<h6 align="right"><b><a href="http://fb.me/erikodiony" target="blank" style="text-decoration: none">PKL-TI (UNPKediri-2015)</a></b></h6>
			</div>
