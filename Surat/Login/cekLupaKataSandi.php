...
<?php  
      ...
      $sqlTampil="select * from login Where user='$_GET[idlogin]' AND level='$_GET[level]'";  
		...
		<div class="modal-content">
			...
			<div class="modal-header">
				<h4 class="modal-title" id="myModalLabel">
					<h4><center><img src="../Images/logo.png" alt="Logo" width="80" height="90">&nbsp &nbsp &nbsp Aplikasi Surat - Menyurat Dinsosnaker</center></h4>
				</h4>
			</div>
